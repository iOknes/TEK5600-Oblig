...
lic_05 = lic(ui, vi, noise_texture(*ui.shape), line_len=0.8, integrator="fe")
plot_lic(ax[0], lic_02, metsim=True)
ax[0].set_title("Metsim - LIC 0.2 line length")
ax[0].invert_yaxis()
plot_lic(ax[1], lic_05, metsim=True)
ax[1].set_title("Metsim - LIC 0.5 line length")
ax[1].invert_yaxis()
